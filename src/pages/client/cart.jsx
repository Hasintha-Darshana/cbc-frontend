...
export default function CartPage(){
    ...
    return(
        <div className="w-full max-w-full  h-full flex flex-col items-center pt-4 relative ">
            <div className="z-50 hidden  w-[300px] h-[80px] shadow-2xl absolute bottom-1 md:top-1 right-1 md:flex flex-col justify-center items-center">
            ...
            </div>
            {
                cart.map(
                    (item)=>{
                        return(
                            <div key={item.productId} className="w-[70%] md:w-[600px] my-4 md:h-[120px] rounded-tl-3xl rounded-bl-3xl bg-primary shadow-2xl flex flex-col md:flex-row relative justify-center items-center p-2 md:pt-0">
